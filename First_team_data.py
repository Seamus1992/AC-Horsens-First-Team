...
# Sidebar for selecting data types
st.sidebar.title('Select Data Types')
selected_data1 = st.sidebar.selectbox('Choose data type 1', [''] + list(Data_types.keys()), key='selected_data1_selectbox')
selected_data2 = st.sidebar.selectbox('Choose data type 2', [''] + list(Data_types.keys()), key='selected_data2_selectbox')
selected_data3 = st.sidebar.selectbox('Choose data type 3', [''] + list(Data_types.keys()), key='selected_data3_selectbox')

# Update session state and run functions if selections change
...
# Columns to display the results
col1, col2, col3 = st.columns(3)
...
# Display the current selection results
if st.session_state['selected_data1']:
    Data_types[st.session_state['selected_data1']]()
